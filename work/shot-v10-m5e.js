'use strict';
/* V10 M5-3b zhenjing 批次2 截图（CDP）
   用法：node work/shot-v10-m5e.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5e-');
...
(async () => {
  ...
  await cdp.shot('01-zhenjing-detail.png', "(()=>{ switchView('books'); openBookDetail('zhenjing'); return true; })()");
  await cdp.shot('02-learn-filter.png', "(()=>{ learnBook='zhenjing'; learnZone='all'; learnTopic='all'; switchView('learn'); renderLearn(); return true; })()");
  await cdp.shot('03-topic-shopping.png', "(()=>{ learnBook='zhenjing'; learnTopic='shopping'; switchView('learn'); renderLearn(); return true; })()");
