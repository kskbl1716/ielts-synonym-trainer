'use strict';
/* V10 M5-5 band9 高分表达批次截图（CDP）
   用法：node work/shot-v10-m5g.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5g-');
...
(async () => {
  ...
  await cdp.shot('01-band9-detail.png', "(()=>{ switchView('books'); openBookDetail('band9'); return true; })()");
  await cdp.shot('02-learn-filter.png', "(()=>{ learnBook='band9'; learnZone='all'; learnTopic='all'; switchView('learn'); renderLearn(); return true; })()");
