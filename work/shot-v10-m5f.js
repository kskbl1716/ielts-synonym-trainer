'use strict';
/* V10 M5-4 awl 学术词汇批次截图（CDP）
   用法：node work/shot-v10-m5f.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5f-');
...
(async () => {
  ...
  await cdp.shot('01-awl-detail.png', "(()=>{ switchView('books'); openBookDetail('awl'); return true; })()");
  await cdp.shot('02-learn-filter.png', "(()=>{ learnBook='awl'; learnZone='all'; learnTopic='all'; switchView('learn'); renderLearn(); return true; })()");
