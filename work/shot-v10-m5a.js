'use strict';
/* V10 M5-1a listening 批次截图（CDP）
   用法：node work/shot-v10-m5a.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5a-');
...
(async () => {
  ...
  await cdp.shot('03-recite-setup.png', "(()=>{ switchView('books'); openBookDetail('listening'); document.getElementById('book-recite-btn').click(); return true; })()");
