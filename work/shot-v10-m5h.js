'use strict';
/* V10 M5-6 oxford 批次1 截图（CDP）
   用法：node work/shot-v10-m5h.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5h-');
...
(async () => {
  ...
  await cdp.shot('02-learn-filter.png', "(()=>{ learnBook='oxford'; learnZone='all'; learnTopic='all'; switchView('learn'); renderLearn(); return true; })()");
  await cdp.shot('03-shelf.png', "(()=>{ switchView('books'); return true; })()");
