'use strict';
/* V10 M5-2 jianqiao 批次截图（CDP）
   用法：node work/shot-v10-m5c.js */
const fs = require('fs');
const path = require('path');
const BASE = 'http://127.0.0.1:9223';
const OUT = path.join(__dirname, 'v10-m5c-');
...
(async () => {
  ...
  await cdp.shot('01-jianqiao-detail.png', "(()=>{ switchView('books'); openBookDetail('jianqiao'); return true; })()");
  await cdp.shot('02-learn-filter.png', "(()=>{ learnBook='jianqiao'; learnZone='all'; learnTopic='all'; switchView('learn'); renderLearn(); return true; })()");
  await cdp.shot('03-flash-setup.png', "(()=>{ flashBook='jianqiao'; switchView('flash'); renderFlashSetup(); return true; })()");
