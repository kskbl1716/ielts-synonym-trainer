...
Start-Sleep -Milliseconds 400
Shot 'font-large-learn'
$null = Eval "(()=>{[...document.querySelectorAll('.tab')].find(t=>t.dataset.view==='practice').click(); [...document.querySelectorAll('#p-types .type-card')].find(c=>c.querySelector('input').value==='mcq').click(); document.querySelector('#p-start').click(); return 1;})()"
Start-Sleep -Milliseconds 500
Shot 'font-large-quiz'
$null = Eval "(()=>{document.querySelector('#quiz-quit').click(); [...document.querySelectorAll('.tab')].find(t=>t.dataset.view==='settings').click(); [...document.querySelectorAll('#set-font .chip')].find(b=>b.dataset.v==='m').click(); return 1;})()"
$ws.Dispose()
exit 0
