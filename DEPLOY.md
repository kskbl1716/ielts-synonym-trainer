...
- 功能：每日目标、打卡系统、生词本、错题本、进度统计、数据导出/导入、深色模式、字号调节、**手机布局**（自动/手动）、词书系统（**13 本词书**）、词库分页渲染、单词难度分级筛选、**艾宾浩斯智能复习**（今日待复习队列 + 例句朗读 + 遗忘曲线可视化 + 学习热力图）、**词根词缀记忆**（2036 学术词词根拆解 + 按词根筛词）、**近义词辨析**（高频同义词用法区分）
- 当前版本 **v11.4**（2026-08-11）：在 v11.3 基础上新增 **扩词**——写作图表词（302）、口语 Part2 专题（344）、学术短语动词（171）三本新词书 + 近义词辨析 note（~150 簇）；v11.3 提供手机布局，v11.2 提供词根词缀，v11.1 提供遗忘曲线/热力图/复习看板，v11.0 提供掌握度5级/艾宾浩斯调度/今日待复习/错题本/例句朗读；历史发布清单见 V9-RELEASE.md / V10-PLAN.md
