...
- 功能：每日目标、打卡系统、生词本、**星标收藏**、错题本、进度统计、数据导出/导入、深色模式、字号调节、**手机布局**（自动/手动）、**每日提醒**（浏览器通知）、词书系统（**13 本词书**）、词库分页渲染、单词难度分级筛选、**艾宾浩斯智能复习**（今日待复习队列 + 例句朗读 + 遗忘曲线可视化 + 学习热力图）、**词根词缀记忆**（2036 学术词词根拆解 + 按词根筛词）、**近义词辨析**（高频同义词用法区分）、**错题主题分析**（薄弱主题+推荐词书）
- 当前版本 **v11.5**（2026-08-11）：在 v11.4 基础上新增 **增强**——单词星标收藏（词库按⭐筛选）、每日提醒（设置开关+时间，浏览器通知）、错题主题分析（统计页薄弱主题+推荐词书）；v11.4 提供扩词三词书+近义词辨析，v11.3 手机布局，v11.2 词根词缀，v11.1 遗忘曲线/热力图/复习看板，v11.0 掌握度5级/艾宾浩斯调度/今日待复习/错题本/例句朗读；历史发布清单见 V9-RELEASE.md / V10-PLAN.md
