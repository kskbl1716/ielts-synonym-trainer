...
- 当前版本 **v10.3**（2026-08-11）：学习中心首页、统一配色系统（浅色/深色）、词书系统 + 背诵模式 + 哈希路由、词库分页渲染、SEO 优化（canonical/OG/JSON-LD/keywords + robots.txt + sitemap.xml）、练习自动发音、首页更新内容、百度统计；历史发布清单见 V9-RELEASE.md / V10-PLAN.md
