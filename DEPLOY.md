...
- 功能：每日目标、打卡系统、生词本、错题本、进度统计、数据导出/导入、深色模式、字号调节、词书系统（**10 本词书**）、词库分页渲染、单词难度分级筛选、**艾宾浩斯智能复习**（今日待复习队列 + 例句朗读 + 遗忘曲线可视化 + 学习热力图）、**词根词缀记忆**（2036 学术词词根拆解 + 按词根筛词）
- 当前版本 **v11.2**（2026-08-11）：在 v11.1 基础上新增 **词根词缀**——2036 学术词标注词根/词缀/记忆提示，单词详情「🔤 词根词缀」区 + 词根标签，词库搜索匹配词根，词库页「词根」筛选条；v11.1 提供遗忘曲线图/学习热力图/复习看板，v11.0 提供掌握度5级/艾宾浩斯调度/今日待复习/错题本/例句朗读；历史发布清单见 V9-RELEASE.md / V10-PLAN.md
