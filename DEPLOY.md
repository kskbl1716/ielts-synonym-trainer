...
## 当前状态
- 词库：**6141 词**（听力专区 4181 / 书写专区 1960），每条含音标、词性、英文释义、中文翻译、例句与关键词高亮、**难度分级**（基础/进阶/高级）
- 练习模式：听写模式、看词选义、听音选义、选择题、配对题、闪卡、背诵模式
- 功能：每日目标、打卡系统、生词本、进度统计、数据导出/导入、深色模式、字号调节、词书系统（**10 本词书**）、词库分页渲染（性能优化）、单词难度分级筛选
- 当前版本 **v10.4**（2026-08-11）：在 v10.3 基础上新增 **单词难度分级**（lv 自动打标：词频表 + awl/band9 锚点，词库/词书/练习/闪卡均可按 基础/进阶/高级 筛选）+ **三批扩词**（NAWL 学术新词 950、口语话题词 227、剑桥 18-20 话题词 200，词库 5622→6141）；历史发布清单见 V9-RELEASE.md / V10-PLAN.md
