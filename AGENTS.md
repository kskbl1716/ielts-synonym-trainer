...
- 当前线上状态：**v11.4 已推送上线**（2026-08-11）：词库 **6533 词**、**13 本词书**、**难度分级**（lv）、**v11.0 智能记忆引擎** + **v11.1 记忆可视化** + **v11.2 词根词缀** + **v11.3 手机布局优化** + **v11.4 扩词**（新增 3 词书：写作图表词 chart 302 / 口语 Part2 专题 part2 344 / 学术短语动词 phrasal 171；**近义词辨析 note 字段** ~150 簇，build 注入，单词详情「🔀 近义词辨析」区）；v10.4 难度分级+三批扩词、v10.3 练习自动发音/首页更新、v10.2 SEO、v10.1 分页、v10.0 词书/背诵/路由均上线
