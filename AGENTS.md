...
- 当前线上状态：**v11.5 已推送上线**（2026-08-11）：词库 **6533 词**、**13 本词书**、**难度分级**（lv）、**v11.0-11.4**（记忆引擎/可视化/词根词缀/手机布局/扩词）+ **v11.5 增强**（单词星标 ⭐：`state.starred` + 词卡/弹窗收藏 + 词库筛选 + 云合并并集；**每日提醒**：设置开关+时间，前台 Notification `scheduleReminder`，Safari 兼容 font-size 字号；**错题主题分析**：统计页按 TOPICS 统计错题+建议薄弱主题词书）；v10.4 难度分级+三批扩词、v10.3 练习自动发音/首页更新、v10.2 SEO、v10.1 分页、v10.0 词书/背诵/路由均上线
