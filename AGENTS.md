...
- 当前线上状态：**v10.0 全部完成，待推送**（2026-08-07）：词库 **5622 词**（听力 4109 / 书写 1513）；7 本词书全部接入：default 2274 / listening 821 / jianqiao 450 / zhenjing 938 / awl 570（78 新 + 492 标记）/ band9 102（61 新 + 41 标记）/ oxford 1000；功能层（词书系统/背诵模式/哈希路由）M1~M4 已推送上线；M5 词条（+3348）与 M6 收尾待本次推送
- 下一步：见 `V10-PLAN.md`（状态已更新为「功能与词书全部完成，待推送」）；发布/回滚资料见 `V9-RELEASE.md`、`V9-PLAN.md`
