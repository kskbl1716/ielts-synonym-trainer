...
- 当前线上状态：词库 2274 词（听力 1210 / 书写 1064）；v10.0 M1~M4 已上线（2026-08-07）：词书系统（7 本词书定义 + 书架/详情/词书筛选）+ 背诵模式 + 哈希路由；词条批量接入（M5）尚未开始
- 下一步：见 `V10-PLAN.md`；发布/回滚资料见 `V9-RELEASE.md`、`V9-PLAN.md`
