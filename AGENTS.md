...
- 当前线上状态：**v11.2 已推送上线**（2026-08-11）：词库 **6141 词**、**10 本词书**、**难度分级**（lv）、**v11.0 智能记忆引擎** + **v11.1 记忆可视化** + **v11.2 词根词缀**（2036 学术词标注 rt 词根/af 词缀拆分/mn 记忆提示，build 期查表注入，单词详情「🔤 词根词缀」区 + 词根标签、词库搜索匹配词根、词库页「词根」chips 按词频 Top 20 筛词；数据 `work/rootdata-1..7.js` 合并表，validate-root.js 0 错）；v10.4 难度分级+三批扩词、v10.3 练习自动发音/首页更新、v10.2 SEO、v10.1 分页、v10.0 词书/背诵/路由均上线
