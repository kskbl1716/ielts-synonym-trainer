...
- 当前线上状态：**v11.3 已推送上线**（2026-08-11）：词库 **6141 词**、**10 本词书**、**难度分级**（lv）、**v11.0 智能记忆引擎** + **v11.1 记忆可视化** + **v11.2 词根词缀** + **v11.3 手机布局优化**（`html[data-layout="mobile"]` ≤640px 自动切换手机版：导航/筛选 chips 单行横滑、memo-stats 3 列、头部紧凑、触摸优化、词卡单列；设置→外观→布局 自动/手机版/桌面版 手动强制；`applyAppearance` matchMedia 监听宽度自动切换）；v10.4 难度分级+三批扩词、v10.3 练习自动发音/首页更新、v10.2 SEO、v10.1 分页、v10.0 词书/背诵/路由均上线
